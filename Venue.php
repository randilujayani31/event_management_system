        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand" href="index.php"><img src="images/a2.jpg" width="119" height="50" alt=""/></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent1">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active"> <a class="nav-link" href="Venue.php">Venue&nbsp;</a></li>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active"> <img src="images/a11.jpg" alt="First slide" width="1200" height="600" class="d-block mx-auto">
              
            </div>
            <div class="carousel-item"> <img src="images/a12.jpg" alt="Second slide" width="1200" height="600" class="d-block mx-auto">
              
            </div>
            <div class="carousel-item"> <img src="images/a13.jpg" alt="Third slide" width="1200" height="600" class="d-block mx-auto">
            ...
            <div class="col-lg-4">
              <div class="card col-md-4 col-lg-12"> <img class="card-img-top" src="images/download (3).jpg" alt="Card image cap">
                <div class="card-body">
                  ...
                  <a href="Events.html" class="btn btn-primary">Read more&nbsp;</a> </div>
              </div>
            </div>
            <div class="col-lg-4">
