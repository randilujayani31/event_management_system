  	  ...
  	  <div class="container">
  	    ...
  	    <h1><div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: grey">
  	      ...
  	      <div class="carousel-inner" role="listbox">
  	        <div class="carousel-item active"> <img src="images/Event-Planning-Business-in-plan.jpg" alt="First slide" width="1200" height="600" class="d-block mx-auto">
  	          
            </div>
  	        <div class="carousel-item"> <img src="images/a4.jpg" alt="Second slide" width="1200" height="600" class="d-block mx-auto">
  	          
            </div>
  	        <div class="carousel-item"> <img src="images/APE_7843.jpg" alt="Third slide" width="1200" height="600" class="d-block mx-auto">
  	          
            </div>
          </div>
  	      <a class="carousel-control-prev" href="#carouselExampleIndicators1" role="button" data-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a> <a class="carousel-control-next" href="#carouselExampleIndicators1" role="button" data-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="sr-only">Next</span> </a> </div>
  	      <h1 style="text-align:center;">WELCOME TO OUR ONLINE EVENT MANAGEMENT SYSTEM</h1>
          <p  style="text-align: center;">With the use of our system,you can manage your special occassion by sitting in a one place.Just share your idea with us.We will make your occassion glamorous.&nbsp;</p>
          <div class="row">
            <div class="col-lg-4">
  	    ...
  	    <div id="accordion1" role="tablist">
  	      <div class="card">
  	        ...
  	        <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordion1">
  	          <div class="card-body"><p style="font-size: 15px;font-family: sans-serif;">Professional Party Planners. Lassana Events Offer a wide rage of customize Event Solutions. We provide a wide range of event solutions. Trusted event rental suppliers in Sri Lanka. Wedding Planning. Event Suppliers Sri Lanka. Meetings &amp; Exhibitions.&nbsp;</p></div>
            </div>
          </div><br>
  	      <div class="card">
  	        <div class="card-header" role="tab" id="headingTwo1">
  	          <h5 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseTwo1" role="button" aria-expanded="false" aria-controls="collapseTwo1"> Categories </a> </h5>
            </div>
  	        <div id="collapseTwo1" class="collapse" role="tabpanel" aria-labelledby="headingTwo1" data-parent="#accordion1">
  	          <div class="card-body">
                <ul>
                  <li>Chairs for Rent</li>
                  <li>Electricals for Rent</li>
                  <li>Flooring & Platforms for Rent</li>
                  <li>Lighting for Rent</li>
                  <li>Marquees for Rent</li>
                  <li>Tables for Rent</li>
                </ul>
              </div>
            </div>
          </div>
